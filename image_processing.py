...
class IP:
    ...
    def getImagePath(self, imagePath) -> str:
        return self.PATH_TO_IMAGES

    def __delattr__(self, name: str) -> None:
        pass

    def determineIfImageContainsPerson(self, imagePath) -> None:
    ...
    def determine_images_with_person(self) -> None:
